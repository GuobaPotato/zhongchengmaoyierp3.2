...
export const CRMCustomers: React.FC = () => {
    ...
    <div className="flex flex-col h-full space-y-6 animate-in fade-in duration-500 pb-20">
      ...
      <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4">
        <div className="flex items-center space-x-1 bg-white p-1 rounded-2xl border border-slate-200 shadow-sm overflow-x-auto scrollbar-hide shrink-0">
          ...
          <button className="px-3 py-2 text-indigo-600 text-xs font-black hover:bg-indigo-50 rounded-xl transition-all">+ 添加场景</button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-6 items-end">
          ...
          <div className="space-y-1.5 lg:col-span-1">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <span className="text-slate-400 text-[10px] font-black uppercase tracking-tighter">至</span>
              <input 
                type="date" 
                className="flex-1 bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 text-xs focus:ring-2 focus:ring-indigo-500 outline-none"
                value={dateRange.end}
      ...
      <div className="bg-white rounded-[2rem] border border-slate-200 shadow-sm overflow-hidden flex flex-col">
              ...
              <tr className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] whitespace-nowrap">
                <th className="px-6 py-5 w-12 text-center sticky left-0 bg-slate-50 z-30 border-r border-slate-100">
                  <input 
                    ...
                    checked={MOCK_CUSTOMERS.length > 0 && selectedIds.size === MOCK_CUSTOMERS.length}
        ...
        {/* 底部批量操作与分页 */}
        <div className="px-10 py-6 border-t border-slate-100 flex flex-col lg:flex-row justify-between items-center gap-6 bg-slate-50/50">
          <div className="flex items-center space-x-8">
            <div className="flex items-center space-x-4">
              <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">批量操作:</span>
            ...
            <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest">
              共 <span className="text-slate-800 text-sm">1</span> 条数据 | 20条/页
            </div>
          </div>
